  ...
  try {
    ...
    if (!coures) {
      ...
      coures = await createCouresModel.create({
        ...
        teacher: [
          {
            name: sectionModel ? sectionModel.class.teacher.name :lactureModel.class.teacher.name ,
    ...
    if (sectionModel) {
      ...
      lectures.forEach((lecture) => {
        ...
        if (lectureExistsIndex === -1) {
          ...
          coures.couresItems.push({
            lacture: lecture,
            teacherID:  name: sectionModel ? sectionModel.class.teacher.name :lactureModel.class.teacher.name ,
            teacherID: sectionModel ? sectionModel.class.teacher._id :lactureModel.class.teacher._id,,
            coupon: couponModel ? couponModel.code : null,
            discount: couponModel ? couponModel.discount : null,
            ip: serverIp,
      ...
      if (lectureExistsIndex === -1) {
        ...
        coures.couresItems.push({
          ...
          teacherID: lactureModel.section.class.teacher._id,
          coupon: couponModel ? couponModel.code : null,
          discount: couponModel ? couponModel.discount : null,
          ip: serverIp,
        });
