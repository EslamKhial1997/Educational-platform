...
exports.createLectures = expressAsyncHandler(async (req, res) => {
  try {
    ...
    const teacherKey = await createTeachersModel.findById(section).then((e) => e.key);
...
exports.updateLecture = factory.updateOne(createLecturesModel , "lec");
exports.deleteLecture = factory.deleteOne(createLecturesModel , "lec");
