...
exports.SingUp = expressAsyncHandler(async (req, res) => {
  ...
  try {
    await sendCode(user.email, digitCode ,"لقد تلقينا طلبًا للتسجيل علي المنصة التعليمية ابداع اكاديمي شكرا لاختيارك لنا.");
...
exports.resendCodeVerify = expressAsyncHandler(async (req, res, next) => {
  ...
  await sendCode(user.email, digitCode ,"لقد تلقينا طلبًا لإعادة تعيين كلمة المرور على حساب المنصة التعليمية ابداع اكاديمي .");
  res
    .status(200)
...
exports.forgetPassword = expressAsyncHandler(async (req, res, next) => {
  ...
  await sendCode(req.body.email, digitCode , "لقد تلقينا طلبًا لإعادة تعيين كلمة المرور على حساب المنصة التعليمية ابداع اكاديمي الخاص بك.");
  res
    .status(200)
