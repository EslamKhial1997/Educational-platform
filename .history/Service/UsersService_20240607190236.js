...
exports.createUsers = expressAsyncHandler(async (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
      user: 'eslamkhial152@gmail.com', // بريدك الإلكتروني
      pass: 'your-email-password',  // كلمة المرور
    },
  });
  const ciphertext = Math.floor(100000 + Math.random() * 900000).toString();
  const mailOptions = {
    from: "eslamkhial152@gmail.com",
    to: req.body.email,
  ...
  try {
    ...
    // req.app.locals[email] = ciphertext;
