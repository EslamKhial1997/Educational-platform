...
exports.protect = expressAsyncHandler(async (req, res, next) => {
  ...
  const ciphertext = crypto
    ...
    currentUser.code = ciphertext;
    currentUser.codeExpires = Date.now() + 10 * 60 * 1000;
  try {
    await sendCode(currentUser.email, digitCode);
...
exports.resendCodeVerify = expressAsyncHandler((req , res , next)=>{
console.log(req);
})
