...
console.log(updateDocById.image.split(baseUrl)[1]===req.body.image);

    // إذا كان هناك صورة جديدة، قم بحذف الصورة القديمة فقط إذا كانت مختلفة عن الصورة الجديدة
    if (updateDocById.image && req.body.image && updateDocById.image.split(baseUrl)[1] !== req.body.image) {
