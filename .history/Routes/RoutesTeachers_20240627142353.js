...
const { createTeachers, UploadImageService } = require("../Service/TeachersService");
...
Routes.route("/")
  .post(allowedTo("manager"),UploadImageService,resize,createTeachersValidator, createTeachers)
  .get(getUsers);
