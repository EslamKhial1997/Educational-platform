...
Routes.route("/").post(uploadImage,createUsersValidator,resizeImage("admin"), createUsers).get(getUsers);
...
.put(uploadImage,createUsersValidator,resizeImage("admin"), updateOneUserValidator, updateUser)
