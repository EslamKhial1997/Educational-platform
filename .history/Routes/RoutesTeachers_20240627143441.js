...
const { createTeachers, UploadImageService, resizeImage, getTeachers ,getTeacher, deleteTeacher } = require("../Service/TeachersService");
const { createTeachersValidator, deleteOneTeacherValidator } = require("../Resuble/TeachersvalidatorError");
// const {
//   createUsersValidator,
//   getOneUserValidator,
...
Routes.route("/")
  .post(allowedTo("manager"),UploadImageService,resizeImage,createTeachersValidator, createTeachers)
  .get(getTeachers);
Routes.route("/verifycode").post(verifyRegister);
Routes.route("/addpoint/:id").put(updateUserPoint);
Routes.route("/:id").get(getOneUserValidator, getTeacher)
