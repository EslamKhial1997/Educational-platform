...
const { createUsers, verifyCode, digetsCodeSend } = require("../Service/UsersService");
...
Routes.route("/").post(createUsersValidator,createUsers);
// Routes.route("/verifycode").post(digetsCodeSend);
//   .get(getUsers);
// Routes.route("/:id")
