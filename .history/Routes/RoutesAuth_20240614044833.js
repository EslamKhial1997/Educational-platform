...
const { verifyRegister, UploadImageService, resizeImage } = require("../Service/UsersService");
...
Routes.route("/signup").post(UploadImageService,resizeImage,createUsersValidator, SingUp);
Routes.route("/verifycode").post(verifyRegister);
Routes.route("/resendVerifycode").post(prote,resendCodeVerify);
