...
Routes.route("/:id")
  ...
  .put(allowedTo("admin", "manager")uploadImage ,updateChapterValidator,resizeImage("chapter"),updateChapter)
  .delete(allowedTo("admin", "manager")deleteChapterValidator, deleteChapter);
