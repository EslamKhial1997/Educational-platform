...
Routes.route("/").post(uploadImage,resizeImage("class"), createClasses).get(getClassess);
Routes.route("/:id").get(getClassValidator, getClass).delete(deleteClassValidator,deleteClass);
