...
const { updatePoint, getTransactions, getTransactionsDate, getTransactionsYear, getAllTransactionsMonth } = require("../Service/TransactionService");
...
Routes.route('/allTransactions/:month' ).get(getAllTransactionsMonth)
