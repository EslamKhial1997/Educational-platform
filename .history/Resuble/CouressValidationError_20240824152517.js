...
exports.createCourseValidator = [
  ...
  check("lacture")
    ...
    .custom(async (val, { req }) => {
      ...
      console.log(req.couponModel.lacture._id);
      
      if (
        !req.couponModel.lacture ||
        (req.couponModel.lacture._id !== req.body.lacture &&
          val !== req.body.lacture)
      ) {
        return Promise.reject(
  ...
  check("section")
    ...
    .custom(async (val, { req }) => {
      ...
      if (
        ...
        (req.couponModel.section._id !== req.body.section &&
