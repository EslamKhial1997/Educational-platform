...
exports.createCourseValidator = [
  ...
  check("lacture")
    ...
    .custom(async (val, { req }) => {
      ...
      if (req.couponModel.lacture._id === req.body.lacture && val !== req.body.lacture) {
        return Promise.reject(
...
console.log(req.couponModel.section);

      // التحقق مما إذا كان الكوبون ينتمي لهذا القسم
      if (!req.couponModel.section ||req.couponModel.section._id !== req.body.section && val !== req.body.section) {
        return Promise.reject(
