...
async function sendCode(toEmail, randomCode, subject) {
  const mailOptions = {
    ...
    html: `<strong>مرحبًا ${toEmail} لقد تلقينا طلبًا لإعادة تعيين كلمة المرور على حساب المنصة التعليمية ابداع اكاديمي الخاص بك. يرجى إدخال هذا الرمز${} . شكرًا لك عزيزي</h6>`,
  };
