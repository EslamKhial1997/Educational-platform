...
function sendCode(toEmail, randomCode) {
  ...
  const mailOptions = {
    ...
    html:  `<strong>Hi ${toEmail}</strong><h5>We Recevid A Request To Rest Password On Your Educational Platform Account</h5> <h3> <strong> ${randomCode}</strong></h3>  <h6>Thanks Dear</h6>`,
  };
