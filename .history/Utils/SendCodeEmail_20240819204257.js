...
async function sendCode(toEmail, randomCode, subject) {
  const mailOptions = {
    ...
    html: `<strong><h1></h1>
    مرحبًا ${toEmail} لقد تلقينا طلبًا لإعادة تعيين كلمة المرور على حساب المنصة التعليمية ابداع اكاديمي الخاص بك. يرجى إدخال هذا الرمز ${randomCode} . شكرًا لك عزيزي</h6>`,
  };
