...
function sendCode(toEmail, randomCode) {
  ...
  const mailOptions = {
    ...
    text:  `<strong>Hi ${toEmail}</strong><h5>We Recevid A Request To Rest Password On Your E Account</h5> <h3>${randomCode} <strong>Please Enter This Code</strong></h3>  <h6>Thanks Dear</h6>`,
  };
